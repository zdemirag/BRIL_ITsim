...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2 nevts:@NEVENTS@'),
...
# Other statements
process.mix.input.nbPileupEvents.averageNumber = cms.double(@PU@)
process.mix.bunchspace = cms.int32(25)
process.mix.minBunch = cms.int32(-12)
process.mix.maxBunch = cms.int32(3)
# process.mix.seed = cms.int32(@SEED@)
process.mix.input.fileNames = cms.untracked.vstring(['file:@PUFILE@'])
